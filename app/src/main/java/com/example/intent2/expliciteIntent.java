...
public class expliciteIntent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explicite_intent);
        ...
        mBtnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent dataIntent = new Intent(expliciteIntent.this, DataActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1000) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(expliciteIntent.this, "User Cancelled operation", Toast.LENGTH_LONG).show();
            }
        }
    }
}